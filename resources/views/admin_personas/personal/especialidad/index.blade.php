...
<form method="get" action={{ route('especialidad.create') }}>

		<button class="btn btn-primary" type="submit">Agregar especialidad</button>
    ...
    <div class="table-responsive">
         <div class="col-md-8 col-md-offset-2">
					 <div class="panel-heading">
							 {!!Form::open(['route'=>'especialidad.index','method'=>'GET']) !!}
								...
								<table class="table table-striped table-hover ">
									...
									@if($profesion)
										...
										<tr>
											<td>{{$h->id}}</td>
											<td>{{$h->get_name()}}</td>
											<td>{!!link_to_route('especialidad.show', $title = 'VER', $parameters = [$h],['class' => 'btn btn-info'], $attributes = [])!!}</td>

											{!! Form::model($h, ['route' => ['especialidad.destroy', $h], 'method'=> 'DELETE'])!!}
...
@endsection
@section('script')
 <script src="{{asset('js/especialidad-script.js')}}"></script>
